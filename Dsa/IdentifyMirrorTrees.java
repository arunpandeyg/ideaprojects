package Dsa;
//check if two binary tree are mirror or not.


public class IdentifyMirrorTrees {
    private static boolean isMirrorImage(Node nodeA, Node nodeB) {
    ...
    a.root = new Node(5);
        ...
        b.root.right.right = new Node(8); //change value and check again for mirror or not.
